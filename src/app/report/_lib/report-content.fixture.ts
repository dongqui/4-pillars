...
export const sampleReport: ReportContent = {
  ...
  decisions: {
    ...
    venturing: "한 번에 크게 걸기보다 잃어도 괜찮은 만큼만 먼저 걸어 보는 쪽이에요. 그게 되는 걸 확인한 뒤에야 거는 몫을 늘려요.",
  ...
  playbook: [
    ...
    {
      title: "혼자 버티기를 독립으로 여기지 않기",
      body: "혼자 끝까지 끌고 가는 힘이 있다 보니 같이 하는 선택지가 아예 안 떠오를 때가 있어요. 일을 맡을 때 어디까지 혼자 하고 어디부터 같이 할지를 미리 갈라 두면, 버티는 힘을 훨씬 오래 쓸 수 있어요.",
    },
    {
