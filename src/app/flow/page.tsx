...
import { analyze, flowYearAt } from "@/lib/saju-core";
...
import { buildYearOptions } from "./_lib/to-confirm";
...
export default async function FlowPage() {
  ...
  const perProfile = await Promise.all(
    rows.map(async (row) => {
      ...
      const years = buildYearOptions({ currentYear, span: FLOW_YEAR_SPAN, birthYear, owned });
