  ...
  return (
    <LegalPage title="개인정보처리방침" updatedAt="2026-08-12">
      ...
      <ul>
        ...
        <li>사주 계산을 위한 입력값: 생년월일시, 성별, (선택) 출생지, (선택) 이름</li>
      ...
      <p>
        로그인하지 않고 입력한 생년월일과 이름은 회원 정보에 저장되지 않고 7일 뒤 자동으로
        사라집니다. 캐릭터를 만들 때 입력한 값은 이용자 브라우저의 쿠키에 보관되며, 리포트 입력값은
        로그인 시 계정으로 옮기기 위해 임시 저장소(Upstash)에 보관됩니다. 브라우저의 쿠키를 지우면
        캐릭터 입력값은 즉시 삭제됩니다.
      </p>
