...
export const FLOW_SECTIONS = {
  overview: {
    ...
    example:
      '{"title":"넓히기보다 내 것을 분명하게 만드는 해","body":"더 오래 이어지는 흐름 하나가 배경에 있지만, 이 해를 실제로 움직이는 건 지금 이 해 자체의 기운이에요. 이전에는 주변 상황을 살피는 일이 중요했다면, 지금은 살펴온 것 가운데 무엇을 남길지 정하는 쪽으로 무게가 옮겨가요. 새로 벌이기보다 이미 가진 것을 분명하게 만드는 편이 이 해의 흐름과 잘 맞아요.","keywords":["정리","선택","연결","지속"]}',
  },
