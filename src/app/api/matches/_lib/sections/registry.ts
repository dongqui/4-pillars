...
export const MATCH_SECTIONS = {
  ...
  chemistry: {
    ...
    example:
      '{"pull":[{"title":"말하지 않아도 상황을 먼저 읽어 줘요","body":"설명을 길게 하지 않아도 통하는 순간이 자주 있어요."},{"title":"서로 다른 속도가 오히려 안심이 돼요","body":"급하게 몰아가는 쪽과 천천히 살피는 쪽이 만나 균형이 맞춰져요."}],"friction":[{"title":"같은 침묵을 서로 다르게 읽어요","body":"한쪽은 배려로 두는 시간을, 다른 쪽은 거리를 두는 신호로 받아들여요."},{"title":"결정을 미루는 방식이 달라요","body":"한쪽은 더 알아본 뒤 정하고 싶어 하고, 다른 쪽은 그 기다림 자체를 답답해해요."}]}',
  },
  ...
  moments: {
    ...
    example:
      '[{"label":"한쪽이 바빠질 때","body":"연락의 간격이 벌어지면 서로 다른 결론을 냅니다. 한쪽은 지금은 그럴 때라 넘기고, 다른 쪽은 마음이 식었다고 읽기 쉬워요."},{"label":"의견이 갈릴 때","body":"한쪽은 바로 말로 풀고 싶어 하고, 다른 쪽은 혼자 정리할 시간이 먼저 필요해요. 이 순서를 못 맞추면 같은 대화를 두 번 하게 돼요."}]',
  },
  ...
  bridge: {
    ...
    example:
      '{"items":["결정을 미룰 때는 미룬다고 말해 두세요. 침묵이 거절로 읽히는 걸 막아 줘요.","의견이 갈리면 그 자리에서 답을 요구하지 마세요. 정리할 시간을 먼저 주는 편이 대화를 짧게 만들어요."],"tip":"서로의 속도가 다르다는 걸 탓하지 말고, 언제까지 답을 줄지만 정해 보세요. 기다리는 쪽이 훨씬 편해져요."}',
  },
