...
export default async function MapEntryPage() {
  ...
  //
  // 다만 이 읽기는 지도를 **처음 만들 때 한 번뿐**이다. 이 함수 맨 위의 getMapByOwner
  // 가 이미 지도가 있으면 그 자리에서 redirect 하고 끝나 여기까지 오지도 않는다 —
  // primary_profile_id 를 나중에 홈에서 바꿔도 이미 만들어진 지도의 중심은 안 따라온다.
  //
