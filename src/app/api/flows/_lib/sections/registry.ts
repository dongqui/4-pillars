...
export const FLOW_SECTIONS = {
  ...
  months: {
    ...
    example:
      '{"lead":"안에서 정리하던 힘이 서서히 밖으로 옮겨가는 한 해예요.","months":[{"monthIndex":1,"title":"방향을 잡는 달","body":"새로운 흐름이 시작되면서 무엇을 계속 가져가고 무엇을 내려놓을지 생각이 많아져요. 바로 크게 움직이기보다 힘을 어디에 쓸지 먼저 정리하는 편이 좋아요."},{"monthIndex":2,"title":"움직임이 살아나는 달","body":"생각으로만 두었던 것을 꺼내보려는 힘이 조금씩 강해져요. 사람과 이야기하거나 작은 결과물부터 만들어보는 것이 흐름을 이어가는 데 도움이 돼요."},{"monthIndex":3,"title":"손에 잡히는 것부터 움직이는 달","body":"머릿속에서만 그리던 일을 실제로 부딪혀보고 싶어지는 장면이 잦아져요. 다 여물지 않았어도 일단 사람들 앞에 내놓아 보는 쪽에 마음이 기울어요."},{"monthIndex":4,"title":"관계가 넓어지는 달","body":"새로 마주치는 사람과 자리가 늘면서 이야기를 나눌 기회도 함께 늘어나요. 낯선 자리라도 가볍게 응해보는 편이 이어지는 흐름에 도움이 돼요."},{"monthIndex":5,"title":"속도가 붙는 달","body":"벌여둔 일들이 손에 익으면서 진행이 눈에 띄게 빨라져요. 여러 일을 한꺼번에 끌고 가느라 정작 중요한 것을 놓치지 않도록 살펴야 해요."},{"monthIndex":6,"title":"벌인 일이 쌓이는 달","body":"손댄 일이 늘어난 만큼 챙겨야 할 것도 함께 늘어나요. 새로 벌이기보다 이미 벌인 것을 감당할 여유를 먼저 확인하는 편이 좋아요."},{"monthIndex":7,"title":"곁에 사람을 불러들이는 달","body":"혼자 붙잡고 있던 일을 옆 사람에게 슬쩍 건네보는 장면이 늘어나요. 부탁하는 말이 평소보다 쉽게 나오는 걸 느낄 수 있어요."},{"monthIndex":8,"title":"되짚어보는 달","body":"바쁘게 벌여온 일들을 잠시 멈춰 되짚어보고 싶은 마음이 올라와요. 무엇이 잘 맞았고 무엇이 헛돌았는지 가려보는 편이 다음 흐름에 도움이 돼요."},{"monthIndex":9,"title":"다시 힘을 모으는 달","body":"되짚어본 것을 바탕으로 다시 움직일 힘이 모여요. 전부를 되살리기보다 남길 만한 것부터 다시 손대는 편이 자연스러워요."},{"monthIndex":10,"title":"가져갈 것과 놓을 것을 가리는 달","body":"벌여둔 일들 가운데 계속 가져갈 것과 정리할 것을 가려보는 장면이 잦아져요. 새로 손을 대기보다 이미 가진 것들 사이에서 추릴 거리부터 찾게 돼요."},{"monthIndex":11,"title":"남길 것을 고르는 달","body":"앞서 추리기 시작한 흐름이 이어지면서 무엇을 끝까지 가져갈지가 더 분명해져요. 손에 남은 것에 힘을 모으는 편이 흐름과 맞아요."},{"monthIndex":12,"title":"한 해를 마무리하는 달","body":"올해 쌓아온 것을 정리하고 다음을 준비하는 힘이 커져요. 새로 벌이기보다 남길 것을 확실히 매듭짓는 데 무게를 두면 좋아요."}]}',
  },
  ...
  pivots: {
    ...
    example:
      '{"lead":"이 해에는 흐름의 방향이 크게 달라지는 지점이 세 번 있어요.","pivots":[{"monthIndex":3,"title":"안에서 밖으로 움직이기 시작하는 지점","body":"앞선 시기까지 생각과 준비에 머물던 힘이 실제 행동과 사람 쪽으로 옮겨가기 시작해요. 여기서부터는 완성도를 높이는 것보다 일단 내보이는 쪽이 흐름과 맞아요."},{"monthIndex":7,"title":"혼자에서 여럿으로 무게가 옮겨가는 지점","body":"앞선 시기까지 혼자 끌고 가던 힘이 사람을 끌어들이는 쪽으로 옮겨가요. 여기서부터는 다 떠안기보다 나눠 맡기는 쪽이 흐름과 맞아요."},{"monthIndex":10,"title":"늘리기보다 남길 것을 고르는 지점","body":"계속 넓혀가던 흐름이 한 차례 꺾이면서 무엇을 유지하고 무엇을 내려놓을지가 중요해져요. 앞선 시기가 벌이는 때였다면 여기서는 추리는 쪽으로 무게가 옮겨가요."}]}',
  },
