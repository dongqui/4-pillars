...
반지름을 **1.6**(지름 3.2)으로 올리면 중앙값 사람은 이웃 2명과 겹치고, 고립되는 사람은 21명 중 2명뿐이다. additive 라 겹친 자리의 알파는 대략 `0.07 × 겹친 수` — 중앙값 자리에서 0.21(자기 것 포함 3겹), 가장 붐비는 자리에서도 5겹 0.35로 화면을 덮지 않는다.
